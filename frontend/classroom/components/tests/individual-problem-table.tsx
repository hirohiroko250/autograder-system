...
import { Edit, Save, CheckSquare, Square, Search } from 'lucide-react';
      ...
      <CardHeader>
        <div className="flex flex-col gap-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <CardTitle className="text-base sm:text-lg">点数入力</CardTitle>
              ...
              <CardContent className="p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className={`text-xs ${student.attendance
                ...
                <div className="grid grid-cols-2 gap-2">
                  {problems.map((problem) => (
                    <div key={problem.number} className="space-y-1">
                      <label className="text-xs font-medium text-muted-foreground">
                        {problem.title || `大問${problem.number}`} (/{problem.maxScore})
                      </label>
                      {editingStudents.has(student.id) ? (
                        ...
                        <div
                          className="h-9 flex items-center justify-center border rounded-md bg-gray-50 cursor-pointer hover:bg-gray-100"
                ...
                <div className="flex items-center justify-between pt-2 border-t">
                  <div className="text-sm">
                    <span className="font-bold">{calculateTotalScore(student.id)}点</span>
                    <span className="text-muted-foreground"> / {calculateMaxTotalScore()}点</span>
                  </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {filteredStudents.length > 0 ? (
                ...
                <tr>
                  <td colSpan={problems.length + 5} className="p-8 text-center text-muted-foreground">
                    <p className="text-sm">検索結果がありません</p>
                    <p className="text-xs mt-1">検索条件を変更してください</p>
                  </td>
                </tr>
