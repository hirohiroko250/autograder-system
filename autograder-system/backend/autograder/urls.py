...
urlpatterns = [
    ...
    path('api/individual-problem-scores/preview-individual-report/', preview_individual_report, name='preview_individual_report_legacy'),
    path('api/individual-problem-scores/preview-bulk-reports/', preview_bulk_reports, name='preview_bulk_reports_legacy'),
